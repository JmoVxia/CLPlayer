...
- (void)createProgress
{
    ...
    _progress.frame          = CGRectMake(_startButton.right + Padding, 0, width - 75 - Padding - _startButton.right - Padding - Padding, Padding);
...
- (void)createCurrentTimeLabel
{
    ...
    _currentTimeLabel.frame     = CGRectMake(0, 0, 75, Padding);
